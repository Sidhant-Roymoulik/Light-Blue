...
// func (engine *engine_version_3_0) mtd_f(position *chess.Position, g int, eval_chan chan int, move_chan chan *chess.Move) {
// 	mtd_f_iter := 0
// 	eval := g
...
// 	engine.quit_mtd = true
// }
// func (engine *engine_version_3_0) mtd_bi(position *chess.Position, eval_chan chan int, move_chan chan *chess.Move) {
// 	mtd_bi_iter := 0
// 	eval := 0
// 	upper := CHECKMATE_VALUE
// 	lower := -CHECKMATE_VALUE
