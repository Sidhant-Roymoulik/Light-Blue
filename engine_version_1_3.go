...
// Upgrades over Version 1.2:
// 		Faster move picking

type engine_version_1_3 struct {
	EngineClass
}

func new_engine_version_1_3() engine_version_1_3 {
	return engine_version_1_3{
		EngineClass{
			name:       "Version 1.3 (MO, AB, ID, QS, DP, TT)",
			max_ply:    0,
...
func (engine *engine_version_1_3) run(position *chess.Position) (best_eval int, best_move *chess.Move) {
	resetCounters()
...
func (engine *engine_version_1_3) iterative_deepening(position *chess.Position) (best_eval int, best_move *chess.Move) {
...
func (engine *engine_version_1_3) minimax_start(position *chess.Position, turn bool) (best_eval int, best_move *chess.Move) {
...
func (engine *engine_version_1_3) minimax(position *chess.Position, ply int, turn bool, alpha int, beta int) (eval int) {
	states++
...
func (engine *engine_version_1_3) q_search(position *chess.Position, ply int, turn bool, alpha int, beta int) (best_eval int) {
	q_states++
